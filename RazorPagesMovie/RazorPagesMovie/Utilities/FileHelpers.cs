...
namespace RazorPagesMovie.Utilities
{
    public class FileHelpers
    {
        public static async Task<string> ProcessFormFile(IFormFile formFile, ModelStateDictionary modelState)
        {
            ...
            // Use reflection to obtain the diplay name for the model
            ...
            // stripany path information passed as part of the
            // FileName property. HtmlEncode the result in case it mush be
            ...
            else
            {
                try
                {
                    ...
                    // new UTF8Encoding(...) to UTF32Encoding().
                    using (
